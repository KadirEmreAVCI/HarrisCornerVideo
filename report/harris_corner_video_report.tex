...
This section reports the Nsight Systems observations collected from the CUDA Harris pipeline. The analysis focuses on three timeline views: (i) kernel execution and stream distribution, (ii) full-frame execution structure, and (iii) stream-enabled non-filtering stages.
